...
# Texture Format
The 4D block textures are stored in the [NDTF (N-Dimensional Texture Format)](https://github.com/Tr1NgleDev/ndtf) format. (btw the ND part of it is a lie it supports only up to 6D in the current version)  
While a viewer app is being developed, you may use these CLIs to convert to and from a standard image format (like .png):
