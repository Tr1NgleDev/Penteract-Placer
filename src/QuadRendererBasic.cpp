...
uint32_t QuadRendererBasic::VAO = 0;
uint32_t QuadRendererBasic::VBO = 0;

void QuadRendererBasic::init()
{
...
void QuadRendererBasic::render(GLenum mode)
{
	if (VAO)
	{
...
void QuadRendererBasic::destroy()
{
	if (VAO)
	{
