...
public:
	struct RenderBuffer
	{
		...
		RenderBuffer(GLenum attachment, GLenum internalFormat, GLenum format, GLenum type)
			: attachment(attachment), internalFormat(internalFormat), format(format), type(type) {
		}
